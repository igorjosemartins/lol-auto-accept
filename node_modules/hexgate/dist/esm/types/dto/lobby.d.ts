...
export interface LobbyDto extends Combine<LcuComponents['schemas']['LolLobbyLobbyDto'] & {
    mucJwtDto?: {
        channelClaim: string;
        domain: string;
        jwt: string;
...
export interface LobbyMemberDto extends Combine<LcuComponents['schemas']['LolLobbyLobbyParticipantDto'] & {
...
export interface LobbyMatchmakingSearchState extends Required<LcuComponents['schemas']['LolLobbyLobbyMatchmakingSearchResource']> {
}
export interface LobbyBotChampionDto extends Required<LcuComponents['schemas']['LolLobbyLobbyBotChampion']> {
}
export interface LobbyInvitationDto extends Required<LcuComponents['schemas']['LolLobbyLobbyInvitationDto']> {
}
/**
