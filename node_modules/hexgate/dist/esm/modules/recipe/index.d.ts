...
import { type RecipeUtils } from './api.js';
import { recipeSymbol } from './symbol.js';
/**
 ...
 * ```
 */
export declare class CreateWithRecipe<T> {
    protected recipe: Recipe<() => Promise<T>>;
    constructor(recipe: Recipe<() => Promise<T>>);
    constructor(api: RecipeApiFn<() => Promise<T>>);
    constructor(recipe: Recipe<() => Promise<T>> | RecipeApiFn<() => Promise<T>>);
 ...
 */
export declare function isRecipeFn<T>(fn: unknown): fn is Recipe<T>;
/**
 ...
 */
export declare function createRecipe<T>(api: (({ build, wrap, to, unwrap, ...api }: RecipeUtils) => T) | RecipeApiFn<T>): Recipe<T>;
