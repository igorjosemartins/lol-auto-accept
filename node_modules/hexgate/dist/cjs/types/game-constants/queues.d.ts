...
export declare namespace Queue {
    export interface Props<QueueId extends NumberLike<Queue.QueueId> = Queue.QueueId, Map extends Queue.Map = Queue.Map, Description extends Queue.Description = Queue.Description, Notes extends Queue.Notes = Queue.Notes> {
    ...
    export type ByQueueId<T extends NumberLike<QueueId>> = {
        [I in keyof Queues]: Queues[I] extends Props<IntoNumber<T>, infer _Map, infer _Description, infer _Notes> ? Queues[I] : never;
    }[keyof Queues];
    /**
    ...
    export type ByMap<T extends Map> = {
        [I in keyof Queues]: Queues[I] extends Props<infer _QueueId, T, infer _Description, infer _Notes> ? Queues[I] : never;
    }[keyof Queues];
    /**
    ...
    export type ByDescription<T extends Description> = {
        [I in keyof Queues]: Queues[I] extends Props<infer _QueueId, infer _Map, T, infer _Notes> ? Queues[I] : never;
    }[keyof Queues];
    /**
    ...
    export type ByNotes<T extends Notes> = {
        [I in keyof Queues]: Queues[I] extends Props<infer _QueueId, infer _Map, infer _Description, T> ? Queues[I] : never;
    }[keyof Queues];
    type Queues = [
        Props<0, 'Custom games', null, null>,
        Props<2, "Summoner's Rift", '5v5 Blind Pick games', 'Deprecated in patch 7.19 in favor of queueId 430'>,
        ...
        Props<8, 'Twisted Treeline', '3v3 Normal games', 'Deprecated in patch 7.19 in favor of queueId 460'>,
        Props<9, 'Twisted Treeline', '3v3 Ranked Flex games', 'Deprecated in patch 7.19 in favor of queueId 470'>,
        ...
        Props<31, "Summoner's Rift", 'Co-op vs AI Intro Bot games', 'Deprecated in patch 7.19 in favor of queueId 830'>,
        Props<32, "Summoner's Rift", 'Co-op vs AI Beginner Bot games', 'Deprecated in patch 7.19 in favor of queueId 840'>,
        Props<33, "Summoner's Rift", 'Co-op vs AI Intermediate Bot games', 'Deprecated in patch 7.19 in favor of queueId 850'>,
        ...
        Props<52, 'Twisted Treeline', 'Co-op vs AI games', 'Deprecated in patch 7.19 in favor of queueId 800'>,
        Props<61, "Summoner's Rift", '5v5 Team Builder games', 'Game mode deprecated'>,
        Props<65, 'Howling Abyss', '5v5 ARAM games', 'Deprecated in patch 7.19 in favor of queueId 450'>,
        Props<67, 'Howling Abyss', 'ARAM Co-op vs AI games', 'Game mode deprecated'>,
        Props<70, "Summoner's Rift", 'One for All games', 'Deprecated in patch 8.6 in favor of queueId 1020'>,
        ...
        Props<91, "Summoner's Rift", 'Doom Bots Rank 1 games', 'Deprecated in patch 7.19 in favor of queueId 950'>,
        Props<92, "Summoner's Rift", 'Doom Bots Rank 2 games', 'Deprecated in patch 7.19 in favor of queueId 950'>,
        Props<93, "Summoner's Rift", 'Doom Bots Rank 5 games', 'Deprecated in patch 7.19 in favor of queueId 950'>,
        Props<96, 'Crystal Scar', 'Ascension games', 'Deprecated in patch 7.19 in favor of queueId 910'>,
        Props<98, 'Twisted Treeline', '6v6 Hexakill games', null>,
        Props<100, "Butcher's Bridge", '5v5 ARAM games', null>,
        Props<300, 'Howling Abyss', 'Legend of the Poro King games', 'Deprecated in patch 7.19 in favor of queueId 920'>,
        Props<310, "Summoner's Rift", 'Nemesis games', null>,
        Props<313, "Summoner's Rift", 'Black Market Brawlers games', null>,
        Props<315, "Summoner's Rift", 'Nexus Siege games', 'Deprecated in patch 7.19 in favor of queueId 940'>,
        Props<317, 'Crystal Scar', 'Definitely Not Dominion games', null>,
        Props<318, "Summoner's Rift", 'ARURF games', 'Deprecated in patch 7.19 in favor of queueId 900'>,
        ...
        Props<800, 'Twisted Treeline', 'Co-op vs. AI Intermediate Bot games', 'Deprecated in patch 9.23'>,
