 ...
 * ```
 */
export type StringIncludes<S extends string, Search extends string, I extends NumberLike<IndexOf<Chars<S>>> = Assert<0, NumberLike<IndexOf<Chars<S>>>>> = SplitAt<S, I> extends [infer _A, infer B] ? B extends `${infer _A}${Search}${infer _B}` ? true : false : never;
